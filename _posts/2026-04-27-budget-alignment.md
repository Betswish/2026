...
description: "We explore a simple two-step recipe—small multilingual SFT followed by math-only GRPO—to align large language models so that both their reasoning traces and final answers stay in the user’s language without paying an accuracy tax, and we analyze where this alignment succeeds, fails, and how to fix regressions."
date: 2026-04-27
future: true
htmlwidgets: true
...
toc:
  ...
  - name: Limitations & threats to validity
---
